...
(
    ...
    `avg_99999`  double             DEFAULT NULL COMMENT '99999日均线',
     `low_1`     double             DEFAULT NULL COMMENT '1日最低价',
    `low_2`     double             DEFAULT NULL COMMENT '2日最低价',
    `low_3`     double             DEFAULT NULL COMMENT '3日最低价',
    `low_4`     double             DEFAULT NULL COMMENT '4日最低价',
    `low_5`     double             DEFAULT NULL COMMENT '5日最低价',
    `low_6`     double             DEFAULT NULL COMMENT '6日最低价',
    `low_7`     double             DEFAULT NULL COMMENT '7日最低价',
    `low_8`     double             DEFAULT NULL COMMENT '8日最低价',
    `low_9`     double             DEFAULT NULL COMMENT '9日最低价',
    `low_10`    double             DEFAULT NULL COMMENT '10日最低价',
    `low_11`    double             DEFAULT NULL COMMENT '11日最低价',
    `low_12`    double             DEFAULT NULL COMMENT '12日最低价',
    `low_13`    double             DEFAULT NULL COMMENT '13日最低价',
    `low_14`    double             DEFAULT NULL COMMENT '14日最低价',
    `low_15`    double             DEFAULT NULL COMMENT '15日最低价',
    `low_16`    double             DEFAULT NULL COMMENT '16日最低价',
    `low_18`    double             DEFAULT NULL COMMENT '18日最低价',
    `low_21`    double             DEFAULT NULL COMMENT '21日最低价',
    `low_31`    double             DEFAULT NULL COMMENT '31日最低价',
    `low_45`    double             DEFAULT NULL COMMENT '45日最低价',
    `low_61`    double             DEFAULT NULL COMMENT '61日最低价',
    `low_91`    double             DEFAULT NULL COMMENT '91日最低价',
    `low_123`    double             DEFAULT NULL COMMENT '123日最低价',
    `low_187`    double             DEFAULT NULL COMMENT '187日最低价',
    `low_365`    double             DEFAULT NULL COMMENT '365日最低价',
    `low_731`    double             DEFAULT NULL COMMENT '731日最低价',
    `low_1095`   double             DEFAULT NULL COMMENT '1095日最低价',
    `low_99999`  double             DEFAULT NULL COMMENT '99999日最低价',
    `high_1`     double             DEFAULT NULL COMMENT '1日最高价',
    `high_2`     double             DEFAULT NULL COMMENT '2日最高价',
    `high_3`     double             DEFAULT NULL COMMENT '3日最高价',
    `high_4`     double             DEFAULT NULL COMMENT '4日最高价',
    `high_5`     double             DEFAULT NULL COMMENT '5日最高价',
    `high_6`     double             DEFAULT NULL COMMENT '6日最高价',
    `high_7`     double             DEFAULT NULL COMMENT '7日最高价',
    `high_8`     double             DEFAULT NULL COMMENT '8日最高价',
    `high_9`     double             DEFAULT NULL COMMENT '9日最高价',
    `high_10`    double             DEFAULT NULL COMMENT '10日最高价',
    `high_11`    double             DEFAULT NULL COMMENT '11日最高价',
    `high_12`    double             DEFAULT NULL COMMENT '12日最高价',
    `high_13`    double             DEFAULT NULL COMMENT '13日最高价',
    `high_14`    double             DEFAULT NULL COMMENT '14日最高价',
    `high_15`    double             DEFAULT NULL COMMENT '15日最高价',
    `high_16`    double             DEFAULT NULL COMMENT '16日最高价',
    `high_18`    double             DEFAULT NULL COMMENT '18日最高价',
    `high_21`    double             DEFAULT NULL COMMENT '21日最高价',
    `high_31`    double             DEFAULT NULL COMMENT '31日最高价',
    `high_45`    double             DEFAULT NULL COMMENT '45日最高价',
    `high_61`    double             DEFAULT NULL COMMENT '61日最高价',
    `high_91`    double             DEFAULT NULL COMMENT '91日最高价',
    `high_123`    double             DEFAULT NULL COMMENT '123日最高价',
    `high_187`    double             DEFAULT NULL COMMENT '187日最高价',
    `high_365`    double             DEFAULT NULL COMMENT '365日最高价',
    `high_731`    double             DEFAULT NULL COMMENT '731日最高价',
    `high_1095`   double             DEFAULT NULL COMMENT '1095日最高价',
    `high_99999`  double             DEFAULT NULL COMMENT '99999日最高价',
