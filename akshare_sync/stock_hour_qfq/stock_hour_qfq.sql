...
(
  ...
  UNIQUE KEY `stock_daily_qfq_symbol` (`symbol`,`trade_time`) USING BTREE,
  UNIQUE KEY `stock_daily_qfq_trade_time` (`trade_time`,`symbol`) USING BTREE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='日线行情'
    /*!50100 PARTITION BY RANGE (MONTH(`trade_time`))
