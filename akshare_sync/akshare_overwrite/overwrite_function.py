...
# user_agent = UserAgent(os=["Windows", "Linux", "Ubuntu", "Mac OS X"]).random
#
# """ 构建 requests 的请求报文头 """
# headers = {
...
#
#
# def request_post(url, data=None, params=None, timeout=20):
#     """
#     基于 requests 库获取网页内容, 考虑到代理的稳定性较低, 引入重试访问, 默认重试 5 次代理访问
#     """
#     max_retry = 10
...
#     while cur_retry < max_retry:
#         try:
#             r = requests.post(url, data=data, params=params, timeout=timeout, proxies=proxies, headers={
#                 "User-Agent": user_agent.random,
#                 "Connection": "close",
#                 "Accept": "text/html,application/xhtml+xml,application/xml",
#                 "Accept-Language": "zh-CN,zh;q=0.9,en;q=0.8"
...
#     # 获取第一页数据，用于确定分页信息
#     r = request_get(url, params=params, timeout=timeout)
#     data_json = r.json()
#     # 计算分页信息
