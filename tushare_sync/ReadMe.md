...
- 同步 [Tushare](https://tushare.pro) 的股票交易数据到本地 Oracle 进行存储, 采用 T + 0 同步方式
...
2022-09-10 09:57:59,720 - trade_cal - INFO - Query data from tushare with api[trade_cal], get_started[19700101]- end[20220910], fields[exchange,cal_date,is_open,pretrade_date]
